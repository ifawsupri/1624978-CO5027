<%@ Page Title="Comic" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Comic.aspx.cs" Inherits="CO5027.Comic" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    ...
    <!---------------------------------------- BOOK 1 ---------------------------------------->
                        ...
                        <button id="myModalBtn1">
                            <img src="images/preachercomic.jpg" alt="Comic"/>
                        </button>
    ...
    <!---------------------------------------- BOOK 2 ---------------------------------------->
                        ...
                        <button id="myModalBtn2">
                             <img src="images/deadpoolcomiccover.jpg" alt="Comic"/>
                        </button>
    ...
    <!---------------------------------------- BOOK 3 ---------------------------------------->
                        ...
                        <button id="myModalBtn3">
                            <img src="images/thewalkingdeadcomiccover.jpg" alt="Comic"/>
                        </button>
